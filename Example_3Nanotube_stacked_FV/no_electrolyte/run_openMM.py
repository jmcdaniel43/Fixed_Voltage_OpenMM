...
Voltage = 40.0 # in Volts, units will be internally converted later...
...
# Need a fair number of iterations to converge charges on nanotubes from initial guess ...
MMsys.Poisson_solver_fixed_voltage( Niterations=15 )
state = MMsys.simmd.context.getState(getEnergy=True,getForces=True,getVelocities=False,getPositions=True)
