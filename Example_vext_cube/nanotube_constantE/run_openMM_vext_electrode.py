...
pdbfile = 'nanotube_between_sheets.pdb'
...
MMsys=MM_FixedVoltage( pdb_list = [ pdbfile, ] , residue_xml_list = [ 'sapt_residues.xml' , ffdir + 'graph_residue_c.xml', 'nanotube9x9_residue_c.xml', ffdir + 'graph_residue_n.xml', 'nanotube9x9_residue_n.xml' ] , ff_xml_list = [ 'sapt_add.xml', 'graph.xml', ffdir + 'graph_c_freeze.xml', 'nanotube9x9_c_freeze.xml' , ffdir + 'graph_n_freeze.xml',  'nanotube9x9_n_freeze.xml' ]  )

# second MMsys on Reference platform to compute vext
MMsys_vext=MM_FixedVoltage_QMMM( pdb_list = [ pdbfile, ] , residue_xml_list = [ 'sapt_residues.xml' , ffdir + 'graph_residue_c.xml',  'nanotube9x9_residue_c.xml', ffdir + 'graph_residue_n.xml', 'nanotube9x9_residue_n.xml' ] , ff_xml_list = [ 'sapt_add.xml', 'graph.xml', ffdir + 'graph_c_freeze.xml', 'nanotube9x9_c_freeze.xml' , ffdir + 'graph_n_freeze.xml', 'nanotube9x9_n_freeze.xml' ] , qmmm_ewald = 'True' , pme_alpha= pme_alpha , pme_grid_size = pme_grid_size_a )
