...
with open(pdbfile) as f:
    for line in f:
        if match in line:
            ...
            sys.stdout.write("%4s  %5s %4s %4s%s%4s    %8.3f%8.3f%8.3f  1.00  0.00      %4s%2s\n" %( line[0:4], line[6:11], line[12:16], line[17:21], line[21:22], line[22:26] , float(line[30:38]) , float(line[38:46]) , float(line[46:54]) + shift_z , line[72:76], line[76:78] ) )
        else:
